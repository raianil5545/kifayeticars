"""
Django settings for kifayeticars project.
...
SECRET_KEY = 'django-insecure-1hg%ylm&w2hti)=lig4u1%(z=uhebbg0avswz_zate#qu4r8@s'
...
# setting models for Custom User model Authentication
